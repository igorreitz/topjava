...
//Начиная с Servlet API 2.3 пул сервлетов не создается, создается только один инстанс сервлетов.
// Те. InMemoryMealRepositoryImpl в нашем случае создается тоже только один раз.
